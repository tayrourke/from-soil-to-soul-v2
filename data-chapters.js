...
<em>Taylor's note: This is what our family drinks. Finding a good source took time, but it changed everything. My children, who showed early signs of dairy sensitivity as infants, thrive on it. The lactase enzyme alone was the game-changer for us. If you have written off dairy because of how your body responds to conventional milk — please try a quality raw source before making that decision permanent.</em>
  ...
  { id:'seasonal-produce', emoji:'🌿', name:'Seasonal Produce Guide', desc:'What to buy each month for peak flavor and nutrition',
    ...
    content:`
    <div class="ch-prose">
      <p>Eating seasonally is one of the most impactful whole foods habits you can build — and one of the least complicated. You don't need a special diet, a new appliance, or a hundred-dollar supplement. You need to buy what's ripe right now, as close to where you live as possible.</p>
      <div class="seasonal-produce-art">
        <img src="./assets/june-seasonal-produce.png" alt="June seasonal produce" loading="lazy" onerror="this.parentElement.classList.add('missing')">
        <div class="seasonal-produce-fallback"><strong>June Seasonal Produce</strong><span>Apricots · Raspberries · Basil · Cherries · Summer squash · Eggplant · Swiss chard · Blackberries · Watermelon · Cucumber · Blueberries · Strawberries · Peaches · Green beans</span></div>
      </div>
